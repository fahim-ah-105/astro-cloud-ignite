  ...
  head: () => ({
    meta: [
      ...
      { title: "Baishan Trade" },
      {
        name: "description",
        content:
          "Vote for the products you want imported to Bangladesh. Free interest reservations, no payment until inspected stock arrives.",
      },
      { property: "og:site_name", content: "Baishan Trade" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Noto+Sans:wght@400;500;600;700&family=Noto+Sans+Bengali:wght@400;500;600;700&display=swap",
      },
